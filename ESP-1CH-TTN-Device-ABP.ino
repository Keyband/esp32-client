...
// network.
static const PROGMEM u1_t NWKSKEY[16] = { 0xE6, 0x60, 0xF7, 0x78, 0x6E, 0xB8, 0xA1, 0xCA, 0x48, 0x57, 0x9E, 0x1D, 0x97, 0x26, 0x63, 0x15 };

// LoRaWAN AppSKey, application session key
// This is the default Semtech key, which is used by the early prototype TTN
// network.
static const u1_t PROGMEM APPSKEY[16] = { 0xF4, 0x76, 0x8A, 0x18, 0x09, 0x6E, 0x1D, 0x3A, 0x30, 0xB7, 0x6E, 0x03, 0x86, 0xBA, 0x95, 0x46 };

// LoRaWAN end-device address (DevAddr)
static const u4_t DEVADDR = 0x26031BFF;
...
void setup() {
  ...
  Serial.print("Canal EU tá pegando");
